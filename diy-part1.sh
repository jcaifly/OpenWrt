...
# 如果你想用 kiddin9 的版本，并且确定它是一个完整的包目录结构
mkdir -p package/luci-app-openclash
svn export https://github.com/kiddin9/kwrt-packages/trunk/luci-app-openclash package/luci-app-openclash

# 2. 添加 Turbo ACC 网络加速引擎软件包及其 LuCI 界面
# echo '添加 Turbo ACC...'
# git clone --depth 1 https://github.com/chenmozhijin/turboacc.git package/luci-app-turboacc
如果坚持使用 kiddin9 的特定版本
mkdir -p package/luci-app-turboacc
svn export https://github.com/kiddin9/kwrt-packages/trunk/luci-app-turboacc package/luci-app-turboacc
...
如果坚持使用 kiddin9 的特定版本
mkdir -p package/luci-app-poweroffdevice
svn export https://github.com/kiddin9/kwrt-packages/trunk/luci-app-poweroffdevice package/luci-app-poweroffdevice
